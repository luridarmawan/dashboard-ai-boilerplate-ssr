...
| **Dokumen terkait** | [`THEMES.md`](./THEMES.md) — spesifikasi & token empat tema bawaan (§4.8, FR-L) · [`ROADMAP.md`](./ROADMAP.md) — urutan pengerjaan, gate keluar, penjaga CI |
...
| I-6 | **[P0]** Endpoint MCP terautentikasi dan tunduk pada tenancy — tidak boleh jadi pintu belakang yang melewati RBAC. |
