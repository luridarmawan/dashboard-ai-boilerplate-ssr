/**
 * Icon set `outline-24` — semantic name → glyph (PRD L-5, §4.8). GENERATED-STYLE FILE, hand-checked:
 * the ONLY place in the web app that imports @lucide/svelte. Components use `<Icon name="save" />`.
