/**
 * Icon set `solid-24` — semantic name → glyph (PRD L-5, §4.8). GENERATED-STYLE FILE, hand-checked:
 * the ONLY place in the web app that imports phosphor-svelte. Components use `<Icon name="save" />`.
...
import BuildingGlyph from 'phosphor-svelte/lib/BuildingsIcon';
import CalendarGlyph from 'phosphor-svelte/lib/CalendarIcon';
import ChevronDownGlyph from 'phosphor-svelte/lib/CaretDownIcon';
import ChevronLeftGlyph from 'phosphor-svelte/lib/CaretLeftIcon';
import ChevronRightGlyph from 'phosphor-svelte/lib/CaretRightIcon';
import ChevronUpGlyph from 'phosphor-svelte/lib/CaretUpIcon';
import ChartBarGlyph from 'phosphor-svelte/lib/ChartBarIcon';
import ChartLineGlyph from 'phosphor-svelte/lib/ChartLineIcon';
import ChartPieGlyph from 'phosphor-svelte/lib/ChartPieIcon';
import SuccessGlyph from 'phosphor-svelte/lib/CheckCircleIcon';
import CheckGlyph from 'phosphor-svelte/lib/CheckIcon';
import CheckDoubleGlyph from 'phosphor-svelte/lib/ChecksIcon';
import LoaderGlyph from 'phosphor-svelte/lib/CircleNotchIcon';
import ClockGlyph from 'phosphor-svelte/lib/ClockIcon';
import ColumnsGlyph from 'phosphor-svelte/lib/ColumnsIcon';
import CopyGlyph from 'phosphor-svelte/lib/CopyIcon';
import DatabaseGlyph from 'phosphor-svelte/lib/DatabaseIcon';
import MoreHorizontalGlyph from 'phosphor-svelte/lib/DotsThreeIcon';
import MoreVerticalGlyph from 'phosphor-svelte/lib/DotsThreeVerticalIcon';
import DownloadGlyph from 'phosphor-svelte/lib/DownloadSimpleIcon';
import MailGlyph from 'phosphor-svelte/lib/EnvelopeIcon';
import EyeGlyph from 'phosphor-svelte/lib/EyeIcon';
import EyeOffGlyph from 'phosphor-svelte/lib/EyeSlashIcon';
import FileGlyph from 'phosphor-svelte/lib/FileIcon';
import SaveGlyph from 'phosphor-svelte/lib/FloppyDiskIcon';
import FolderGlyph from 'phosphor-svelte/lib/FolderIcon';
import FilterGlyph from 'phosphor-svelte/lib/FunnelIcon';
import SettingsGlyph from 'phosphor-svelte/lib/GearIcon';
import GridGlyph from 'phosphor-svelte/lib/GridFourIcon';
import ServerGlyph from 'phosphor-svelte/lib/HardDrivesIcon';
import HomeGlyph from 'phosphor-svelte/lib/HouseIcon';
import ImageGlyph from 'phosphor-svelte/lib/ImageIcon';
import InfoGlyph from 'phosphor-svelte/lib/InfoIcon';
import KeyGlyph from 'phosphor-svelte/lib/KeyIcon';
import LinkGlyph from 'phosphor-svelte/lib/LinkIcon';
import ListGlyph from 'phosphor-svelte/lib/ListBulletsIcon';
import MenuGlyph from 'phosphor-svelte/lib/ListIcon';
import LockGlyph from 'phosphor-svelte/lib/LockIcon';
import UnlockGlyph from 'phosphor-svelte/lib/LockOpenIcon';
import SearchGlyph from 'phosphor-svelte/lib/MagnifyingGlassIcon';
import MinusGlyph from 'phosphor-svelte/lib/MinusIcon';
import MonitorGlyph from 'phosphor-svelte/lib/MonitorIcon';
import MoonGlyph from 'phosphor-svelte/lib/MoonIcon';
import PaletteGlyph from 'phosphor-svelte/lib/PaletteIcon';
import SendGlyph from 'phosphor-svelte/lib/PaperPlaneTiltIcon';
import PauseGlyph from 'phosphor-svelte/lib/PauseIcon';
import EditGlyph from 'phosphor-svelte/lib/PencilSimpleIcon';
import PlayGlyph from 'phosphor-svelte/lib/PlayIcon';
import PlugGlyph from 'phosphor-svelte/lib/PlugIcon';
import PlusGlyph from 'phosphor-svelte/lib/PlusIcon';
import PuzzleGlyph from 'phosphor-svelte/lib/PuzzlePieceIcon';
import HelpGlyph from 'phosphor-svelte/lib/QuestionIcon';
import ShieldGlyph from 'phosphor-svelte/lib/ShieldIcon';
import LoginGlyph from 'phosphor-svelte/lib/SignInIcon';
import LogoutGlyph from 'phosphor-svelte/lib/SignOutIcon';
import SparklesGlyph from 'phosphor-svelte/lib/SparkleIcon';
import DashboardGlyph from 'phosphor-svelte/lib/SquaresFourIcon';
import StarGlyph from 'phosphor-svelte/lib/StarIcon';
import StopGlyph from 'phosphor-svelte/lib/StopIcon';
import SunGlyph from 'phosphor-svelte/lib/SunIcon';
import SwitchGlyph from 'phosphor-svelte/lib/SwapIcon';
import TagGlyph from 'phosphor-svelte/lib/TagIcon';
import LanguageGlyph from 'phosphor-svelte/lib/TranslateIcon';
import TrashGlyph from 'phosphor-svelte/lib/TrashIcon';
import UploadGlyph from 'phosphor-svelte/lib/UploadSimpleIcon';
import UserGlyph from 'phosphor-svelte/lib/UserIcon';
import UsersGlyph from 'phosphor-svelte/lib/UsersIcon';
import GroupGlyph from 'phosphor-svelte/lib/UsersThreeIcon';
import WarningGlyph from 'phosphor-svelte/lib/WarningIcon';
import ErrorGlyph from 'phosphor-svelte/lib/XCircleIcon';
import CloseGlyph from 'phosphor-svelte/lib/XIcon';
import XGlyph from 'phosphor-svelte/lib/XIcon';
