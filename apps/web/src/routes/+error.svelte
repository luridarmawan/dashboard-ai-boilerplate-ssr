 ...
 * The 404 is the one visitors actually meet (a mistyped link, a page that moved), so the scene
 * from `static/404.png` fills the screen and the copy sits in its centre; the rest stay plain
 * and to the point.
 */
const t = useT();
